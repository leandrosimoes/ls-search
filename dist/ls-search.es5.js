...
;(function (window, document) {
                ...
                default:
                    ...
                    timeout = setTimeout(function () {
                        ...
                        if (!!LsPriorities && LsPriorities.length > 0) {
                            ...
                            var orderPriorities = function orderPriorities(engines, priorities) {
                                var orderedArray = [];
    ...
    var ls_search = function ls_search(options) {
        ...
        var _ls_search = {
            ...
            setPriorities: function setPriorities(priorities) {
            ...
            clearPriorities: function clearPriorities() {
                LsPriorities = [];

                return this;
            },
            setFilter: function setFilter(filterFunction) {
